...
This document lists all of the measures, including contextual measures, used by
Measures for Justice.  Based on the state selected for download, this document
specifies what measures are and are not available in that state, sources for
each measure for that state, and any state-specific notes, in addition to
general notes and descriptions for each measure.

* methodology.pdf

This document describes the Measures for Justice Methodology in detail,
including the conceptual development, data collection, data management, data
quality control, measure calculation, and measure visualization for the
Measures.  Particularly relevant to the data files accompanying this readme are
Part 3 (Data Management) which describes the variables used by MFJ, and Part 5
(Measure Calculation) which describes each measure in detail.
...
measure, filter, and location.  The missing column lists how many cases were
